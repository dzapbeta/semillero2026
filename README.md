...
| 4 | `04-playwright-pom` | Frameworks de automatización (Playwright). POM (Page Object Model) | Martes 29 de septiembre de 2026, 9:00 a.m. a 12:00 m. | Jueves 1 de octubre de 2026, 8:00 a.m. |
...
Todas las ramas usan lo mismo, en Windows 10 u 11:

- Java JDK 21 (Eclipse Temurin)
- Gradle 9.7.1 instalado en tu equipo (los proyectos no traen wrapper, se ejecutan con `gradle`)
- Git
- IntelliJ IDEA con los plugins Cucumber for Java y Gherkin
- Google Chrome (clases 2 y 4)
...
Todas las ramas tienen la misma forma, así sabes dónde buscar:
...
escríbeme con una captura del error, la salida de `java -version`, `gradle -v` y `git --version`, y qué
estabas haciendo.
